...
import old.lingvo.{LingvoClient, LingvoProcessor, LingvoService}
import old.oxford.{OxfordClient, OxfordFormatter, OxfordServiceImpl}
import old.persistence.Db
import old.persistence.dao.{ArticleDao, AskingDao, QueryDao}
import old.service.{ArticleService, AskingService, Monster, QueryService}
import old.telegram.TelegramImpl
