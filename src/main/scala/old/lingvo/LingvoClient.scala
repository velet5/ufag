...
import old.client.HttpMethod.GET
import old.client._
import com.fasterxml.jackson.databind.ObjectMapper
import old.exception.EmptyBodyException
import old.configuration.LingvoProperties
import org.apache.http.HttpHeaders.AUTHORIZATION
import old.persistence.model.Provider
import old.service.ArticleService
import old.util.TextUtils.isCyrillic
import old.util.UrlUtils.encode
